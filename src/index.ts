...
import bettermath, { getRefIds } from "./functions/grammar/bettermath"
...
const grammar = bettermath()
const expression = grammar.tryParse(`=SUM(1,REF("B2")) +   SUM(REF("A1"), 2) + REF("A1")`)
console.log("SET OF REFS:", getRefIds(expression));
